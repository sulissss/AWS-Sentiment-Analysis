...
def download_nltk_resource(url: str, target_dir: str):
    """
    Downloads the raw zip file and extracts it properly for NLTK,
    keeping both the .zip archive and extracted structure intact.
    """
...
class RedditTextCleaner:
    ...
    def _ensure_nltk_resources():
        """Silently verify or download required NLTK corpora using requests."""
        ...
        try:
            ...
            download_nltk_resource(
                f"{base_url}/corpora/stopwords.zip",
                os.path.join(nltk_data_dir, "corpora")
            )
        ...
        try:
            ...
            download_nltk_resource(
                f"{base_url}/corpora/wordnet.zip",
                os.path.join(nltk_data_dir, "corpora")
            )
